...
public class SameEmailMRAlgorithm {

    public static class SameEmailMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable> {
        @Override
    ...
    public static class SameEmailReducer extends MapReduceBase implements Reducer<Text, IntWritable, Text, Text> {
        @Override
    ...
    public static void main(String[] args) throws Exception {
        String input = "hdfs://192.168.1.243:9000/user/hdfs/o_same_email";
        String output = "hdfs://192.168.1.243:9000/user/hdfs/o_same_email/result";

        // JobConf conf = MyConf.getConf(DemoTT.class, MyConf.ENV.TIANJI);
        JobConf conf = new JobConf(SameEmailMRAlgorithm.class);
        ...
        conf.setMapperClass(SameEmailMapper.class);
        conf.setReducerClass(SameEmailReducer.class);
